...
private const val ANDROIDX_LIFECYCLE_KTX_VERSION = "2.3.0"
private const val ANDROIDX_TEST_JUNIT_VERSION = "1.1.2"
private const val ANDROIDX_TRANSITION_KTX_VERSION = "1.4.0"
...
object Dependencies {
    ...
    const val androidxLifecycleRuntimeKTX = "androidx.lifecycle:lifecycle-runtime-ktx:$ANDROIDX_LIFECYCLE_KTX_VERSION"
    const val androidxLifecycleCommonJava8 = "androidx.lifecycle:lifecycle-common-java8:$ANDROIDX_LIFECYCLE_KTX_VERSION"
    const val androidxLifecycleViewModelKTX = "androidx.lifecycle:lifecycle-viewmodel-ktx:$ANDROIDX_LIFECYCLE_KTX_VERSION"
    const val androidxLifecycleLiveDataKTX = "androidx.lifecycle:lifecycle-livedata-ktx:$ANDROIDX_LIFECYCLE_KTX_VERSION"
    const val androidxTestJunit = "androidx.test.ext:junit:$ANDROIDX_TEST_JUNIT_VERSION"
    const val androidxTransitionKTX = "androidx.transition:transition-ktx:$ANDROIDX_TRANSITION_KTX_VERSION"
